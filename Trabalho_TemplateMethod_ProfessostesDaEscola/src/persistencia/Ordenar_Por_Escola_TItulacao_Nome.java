 ...
 * @author dener
 */
public class Ordenar_Por_Escola_TItulacao_Nome extends ProfessorPersistenciaTemplateMethod{
    //Construtores
   
    public Ordenar_Por_Escola_TItulacao_Nome() {
    }
    
    public Ordenar_Por_Escola_TItulacao_Nome(String nomeDoArquivo) {
        super(nomeDoArquivo);
    }
